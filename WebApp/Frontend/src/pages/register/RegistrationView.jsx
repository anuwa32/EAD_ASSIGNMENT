...
const Reg = () => {
  ...
  const handleSubmit = async(values, { setSubmit }) => {
    ...
    try {
      const response = await axios.post('http://localhost:5019/api/TravelerProfile', data);
  ...
  return (
    ...
    >
      <Card className="container" style={{ height: "800px", width: "1000px", backgroundColor: "rgba(231, 231, 231, 0.7)", borderRadius: "15px", boxShadow: "0px 0px 50px rgba(0, 0, 0, 0.7)" }}> 
        <Card.Body>
          <Row>
            <Col className="fixed ">
                  ...
                  <Form>
                    ...
                    <label htmlFor="fName" style={{ fontWeight: "bold", color: "#333", backgroundColor: "rgba(231, 231, 231, 0.7)", paddingLeft: "5px", paddingRight: "5px", borderRadius: "10px", width: "100px" }}>First Name</label>
                      <Field
                        ...
                        name="fName"
                        id="fName"
                        style={{ width: "90%", borderColor: "#ccc", backgroundColor: "#f0eded" }}
                    ...
                    <div className="form-group">
                    <label htmlFor="role" style={{ fontWeight: "bold", color: "#333", backgroundColor: "rgba(231, 231, 231, 0.7)", paddingLeft: "5px", paddingRight: "5px", borderRadius: "10px", width: "100px" }}>Role</label>
                      <Field
                        as="select"
                        name="role"
                        id="role"
                    ...
                    <p className="mt-3" style={{ color: "#333", backgroundColor: "rgba(231, 231, 231, 0.9)", paddingLeft: "5px", paddingRight: "5px", borderRadius: "10px", width: "250px" }}>
                      Already Registered?{" "}
                      <Link to="/" style={{ color: "rgba(255, 0, 0, 1)" }}>
                        Sign In
                      </Link>
                    </p>
                  </Form>
